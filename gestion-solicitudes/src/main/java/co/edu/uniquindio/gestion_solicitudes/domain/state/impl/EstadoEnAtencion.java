...
@Component
public class EstadoEnAtencion implements EstadoSolicitudState {

    @Override
    public void clasificar(SolicitudAcademica solicitud, Usuario ejecutor, Object payload){
        throw new IllegalStateException("Transición no permitida desde EN_ATENCION.");
    }

    @Override
    public void iniciarAtencion(SolicitudAcademica solicitud, Usuario ejecutor, String observacion){
        throw new IllegalStateException("La solicitud ya está en atención.");
    }
    ...
    @Override
    public void cerrar(SolicitudAcademica solicitud, Usuario usuario, String observacion){
        throw new IllegalStateException("Transición no permitida desde EN_ATENCION.");
    }
